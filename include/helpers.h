...
#define LIGHT_CLAMP(val, min, max)                                             \
  (val < min ? light_log_clamp_min(min)                                        \
             : (val > max ? light_log_clamp_max(max) : val))
...
#define LIGHT_NOTE(fmt, args...)                                               \
  LIGHT_LOG(LIGHT_NOTE_LEVEL, stdout, " Notice: " fmt, ##args)
#define LIGHT_WARN(fmt, args...)                                               \
  LIGHT_LOG(LIGHT_WARN_LEVEL, stderr, " Warning: " fmt, ##args)
#define LIGHT_ERR(fmt, args...)                                                \
  LIGHT_LOG(LIGHT_ERROR_LEVEL, stderr, " Error: " fmt, ##args)
